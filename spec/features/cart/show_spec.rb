...
RSpec.describe 'Cart Show Page' do
  describe 'As a Visitor' do
    before :each do
      ...
      @soldier = @megan.items.create!(name: 'Soldier', description: "I'm a Soldier!", price: 50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 300 )
    end
    ...
    it "shows a discount if the minimum quantity of items has been added" do
      ...
      visit item_path(@soldier)

      click_button 'Add to Cart'

      visit '/cart'

        within "#item-#{@soldier.id}" do
          click_button "More of This!"
        end
